...
usage() {
    ...
    echo "  rpi      - build for Raspberry Pi 4."
    echo ""
    echo "Optional arguments:"
    echo "  SDK_PATH - Path to KasperskyOS CE SDK."
    echo ""
    echo "Examples:"
    echo "  ./cross-build.sh qemu"
    echo "  ./cross-build.sh rpi \"/opt/KasperskyOS-Community-Edition-1.1.1.13\""
    echo ""
}

SDK_PATH="/opt/KasperskyOS-Community-Edition-1.1.1.13"
...
then
    TARGET_PLATFORM="kos-image"
else
    echo "Unknown target platform specified"
    usage
    exit 1
fi
